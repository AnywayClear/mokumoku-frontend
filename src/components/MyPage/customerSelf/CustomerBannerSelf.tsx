      ...
      <div className="bg-stone-200 h-700 w-full flex justify-center pt-20 pb-12">
        ...
        <div className="text-left pt-24 w-[25rem]">
          ...
          <div className="flex pt-4">
            ...
            <u
              className="text-xl text-stone-700 hover:opacity-70 cursor-pointer"
