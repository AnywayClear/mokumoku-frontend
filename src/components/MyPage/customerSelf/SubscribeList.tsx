        ...
        <div>
            ...
            >
                {subscribeUsers.map((subscribeUser,index) => (
                    <div className={`${subscribeUser.selected?"":"hover:opacity-80 opacity-30"} px-4 select-none`} key={index}>
                        <Image src={subscribeUser.img} width={200} height={200} alt={"UserImg" + `${subscribeUser.name}`} className="h-48 w-48 object-cover rounded-full pointer-events-none"></Image>
                            <p className="truncate text-2xl w-48 font-bold text-cente my-4 text-center select-none">{subscribeUser.name}</p>
                        </div>
                    )
                )}
            </div>
            ...
            <table className='table-fixed border-collapse border-y-2 w-full text-center mt-6 my-20 border-neutral-300'>
                    ...
                    <tbody>
                        ...
                        (<tr key={index2} className="border-y text-lg">
                            ...
                            <td><a href="#"><p className='px-6 py-6 underline truncate hover:opacity-70'>{row.title}</p></a></td>
                            <td><p>{row.unit}</p></td>
                            <td><p>{row.date}</p></td>
                            <td><p>{row.state}</p></td>
                            <td><p>{row.price}</p></td>
