            ...
            <div>
                ...
                <div className="flex w-full justify-between mb-10">
                    ...
                    <div className="border-t-4 border-2 rounded-md w-72 h-auto py-4 px-6 border-neutral-400">
                        <p className="text-2xl font-semibold text-neutral-500 mb-3">어제 결제 금액</p>
                        <p className="text-3xl font-bold text-neutral-800 mb-4">7.2만원</p>
                        <div className='flex items-center'>
                            <p className="text-xl font-semibold text-neutral-500 mr-10">기준일 대비</p>
                ...
                <div className='mt-20'>
                    ...
                    <div className='border rounded-md p-2 mt-6'>
                        <Chart type='bar' height={500} options={columnOptions.options} series={columnOptions.series}/>
                    </div>
                </div>
            </div>
        </div>
